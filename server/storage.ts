import { 
  categories, designs, orders, testimonials,
  type Category, type Design, type Order, type Testimonial,
  type InsertCategory, type InsertDesign, type InsertOrder, type InsertTestimonial
} from "@shared/schema";
import { db } from "./db";
